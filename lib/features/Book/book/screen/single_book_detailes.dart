...
import '../../report/screen/singleImageViewer.dart';
...
// }
  ...
  Future<double> getCredit() async {
    credit= await  ref.read(bookControllerProvider.notifier).getCredit(widget.bookData.bookId??"");
    // await ref.read(bookControllerProvider.notifier).getCredit(widget.bookData.bookId??"");

  return credit;
  }
  Future getUsers() async {

   await  ref.read(bookControllerProvider.notifier).getUsers(widget.bookData.members??[]);
  ...
  void initState() {
    ...
    //ref.read(bookControllerProvider.notifier).getCredit(widget.bookData.bookId??"");
    getCredit();
           ...
           Expanded(
            child: Consumer(
              builder: (BuildContext context, WidgetRef ref, Widget? child) {
                final transactionData=ref.watch(getAllTransactionPurchasein30daysProvider);
                return transactionData.when(data: (value){
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          width: width*0.55,
                                          child: Text(value[index].customerName,
                                            style:  GoogleFonts.montserrat(color:primarycolor1,fontWeight: FontWeight.w700,fontSize: 14),) ,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Text(value[index].currencyShort.toString(), style: GoogleFonts.montserrat(color:value[index].toJson().containsKey('purchaseId') ?Colors.black:Colors.green,fontWeight: FontWeight.w600,fontSize: 15),),
                                        const SizedBox(width: 3,),
                                        Text(value[index].amount.toString(), style: GoogleFonts.montserrat(color:value[index].toJson().containsKey('purchaseId')?Colors.black:Colors.green,fontWeight: FontWeight.w600,fontSize: 15),),
                                      ],
                                    ),
                                            ...
                                            showDialog(
                                                ...
                                                builder:
                                                  ...
                                                  return EditAmountPage(
                                                    id:value[index].type==0? value[index].purchaseId.toString():value[index].transactionId,
                                                    type: value[index].type,
                                                    data: value[index],
                                                    nobook:value[index].noBook,
                                                    userId:value[index].customerId,
                                                    bookId:value[index].bookId,
