...
import '../../report/screen/company_report.dart';
            ...
            children: [
              ...
              Consumer(
                builder: (context,ref, child) {
                  ...
                  final transactionData=ref.watch(getAllTransactionPurchaseProvider);
                  ...
                  }, error: (Object error, StackTrace stackTrace) { return Text(''); }, loading: () {
                            ...
                            return  Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  ...
                                  QuerySnapshot<Map<String,dynamic>> event =  await FirebaseFirestore.instance.collection('shops')
                                      .doc(currentshopId).collection('book').where('delete',isEqualTo: false).
                                  where('bookName',isEqualTo: value[index].bookName).
                                  get();
                                  if(event.docs.isNotEmpty){
                                    data=BookModel.fromJson(event.docs[0].data());
                                  }
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(DateFormat('dd MMM yyyy hh:mm aa').format(value[index].toJson().containsKey('date')?value[index].date:value[index].date),
                                                style:  GoogleFonts.montserrat(color:Colors.black,fontWeight: FontWeight.w600,fontSize: 11),),
                                              const SizedBox(height: 5,),
