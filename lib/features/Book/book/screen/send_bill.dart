...
class SendBill extends ConsumerStatefulWidget {
  final String phone;
  final String name;
  final String id;
  final String bookId;
  ...
  @override
  ConsumerState<SendBill> createState() => _SendBillState();
}

class _SendBillState extends ConsumerState<SendBill> {
  ...
  createPurchase(PurchaseModel purchaseData,BuildContext context){
    ...
    createPurchase(  purchaseData: purchaseData, context: context,);
...
//Open the PDF document in mobile
    if(isChecked){
      final purchaseData = PurchaseModel(
          ...
          type: 0,
          delete: false);
      await createPurchase(purchaseData,context);
