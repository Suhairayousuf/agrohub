...
//   const AddTransactionPage({Key? key, required this .iqamaNumber}) : super(key: key);
//
//   @override
...
//                                     child: customerImage!=""?
//                                     CachedNetworkImage(imageUrl:customerImage ,fit: BoxFit.cover,):
//                                     Image.asset( 'assets/images/singleUser.png')
//                                 ),
//                               ),
//                             ),
//                             Column(
...
//     );
//   }
//   createTransaction( TransactionModel transactionData,) async {
//     String? id;
//     FirebaseFirestore.instance.collection('users')
//         .doc(customerId).collection('transactions').add(transactionData.toJson())
//         .then((value) {
//
...
//           'credit':FieldValue.increment((transactionData.amount!)*-1),
//           'update':DateTime.now()
//         });
//
//       });
