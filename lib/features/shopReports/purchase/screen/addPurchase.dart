                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        if(invoiceNo!=''&&description!=''
                          ...
                          await FirebaseFirestore.instance.collection('purchases')
                              ...
                              .add(
                              {
                                ...
                                FirebaseFirestore.instance.collection('shops')
                                    .doc(currentshopId)
                                    .update({
                                  'totalPurchase':FieldValue.increment(num.tryParse(amount)??0),
                                });
                          });
                          ...
                          showUploadMessage1(context, 'Purchase Added Succesfully',style:GoogleFonts.montserrat());
                          setState(() {
